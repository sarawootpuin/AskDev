...
@Component({
  selector: 'app-blacklist-ncb-showenquiry',
  templateUrl: './blacklist-ncb-showenquiry.component.html'
})
export class BlacklistNcbShowEnquiryComponent implements OnInit {

  @Input()pname:string="";
  @Input()psurname:string="";
  @Input()ptradeid:string="";
  @Input()pNcbRunNo:string="";

  @Input() showMktCheckDate: boolean;
  @Input() showSentNcbDate: boolean;
  @Input() showMktName: boolean;
  @Input() showEntName: boolean;
  @Input() showEntSurname: boolean;
  @Input() showBlResult: boolean;
  @Input() showResultNcb: boolean;
  ...
  constructor(private blacklistNcbService: BlacklistNcbService,
    ...
    this.showMktCheckDate =false;
    this.showSentNcbDate=false;
    this.showMktName=false;
    this.showEntName=false;
    this.showEntSurname=false;
    this.showBlResult=false;
    this.showResultNcb=false;
  }
